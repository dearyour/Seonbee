...
public class FriendController {
    ...
    public ResponseEntity<? extends BaseResponseBody> followFriend(
        ...
        else if (followFriendCode==402)  return ResponseEntity.status(402).body(BaseResponseBody.of(402, "이미 벗 요청을 했습니다."));
        else if (followFriendCode==405)  return ResponseEntity.status(405).body(BaseResponseBody.of(405, "이미 벗입니다."));
        else if (followFriendCode==406) return ResponseEntity.status(406).body(BaseResponseBody.of(406, "자기 자신에게 벗 요청할 수 없습니다."));
