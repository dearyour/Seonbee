...
public class WishController {
    ...
    public ResponseEntity<? extends BaseResponseBody> reserveWishlist(
        ...
        else if (reserveWishlistCode==402)  return ResponseEntity.status(402).body(BaseResponseBody.of(402, "이미 예약된 상품입니다."));
    ...
    public ResponseEntity<? extends BaseResponseBody> deleteWishlist(
        ...
        else if (deleteWishlistCode==403)   return ResponseEntity.status(403).body(BaseResponseBody.of(403, "사용자 권한이 없습니다."));
